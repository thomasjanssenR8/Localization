"""
Plot a map with Antwerp in the center. The radius of each circle represents the median error per location.
"""
...
for i in range(2, 38):
    errors_wigle.append(sheet1.cell(row=i, column=4).value)             # Load WiGLE median errors
    errors_locationAPI.append(sheet1.cell(row=i, column=5).value)       # Load LocationAPI median errors
